...
class PortScanner(Scanner):
    ...
    # TODO: Write init(self, target, ports)
    #   Call the parent constructor: super().init(target)
    #   Store self.ports (a list of port numbers)
    def init(self, target, ports):
        super().init(target)
        self.ports = ports
...
class HTTPScanner(Scanner):
    ...
    # TODO: Write init(self, target, paths)
    #   Call the parent constructor: super().init(target)
    #   Store self.paths (a list of URL paths like "/", "/admin")
    def init(self, target, paths):
        super().init(target)
        self.paths = paths
